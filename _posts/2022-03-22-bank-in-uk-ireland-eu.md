...
但因為在歐元區的緣故，基本上只要在歐元區擁有 IBAN 帳戶號碼，不論銀行國家，根據歐盟的共同條款皆需要允許使用以達合規，否則可能視為 IBAN discrimination，甚至有權可以舉報[^accept-my-iban]。這同樣也是用在相關的網路銀行、FinTech：

- N26
- Revolut
- WISE

為了幫助你快速了解各項愛爾蘭銀行的差異，下表列舉了在愛爾蘭常用的銀行和各項比較：
...
| ATM withdrawal fee           | €0.35 | €0.60   | €0.00 | €0.50 - first 5 free | €0.00 | €0.00 - as above                 | €2.00 - first 3 free N26 €1 or 2% - first €200 or 5 free Revolut  | €0.00 |
...
在愛爾蘭開戶，如果是人生在愛爾蘭第一個銀行帳戶，可以請求銀行開啟 [Basic Account](https://www.citizensinformation.ie/en/money_and_tax/personal_finance/banking/standard_bank_account.html)，各家銀行適用，開啟 Basic Account，第一年免帳管費，未來銀行可根據條件持續免帳管費用。

### N26

N26 是德國十分方便的網路銀行並且提供免費的活期帳戶，**不需要地址證明文件**即可申請，客服主要使用英文，不需要會德文即可操作，這對於很多外國人到歐洲開戶是非常便利的選擇之一。

如果是台灣人在愛爾蘭開戶，全程只需要透過手機 App 上傳護照和 IRP (愛爾蘭居留證)，並且會即時安排真人透過視訊驗證文件，即可在幾分鐘內完成開戶。N26 網路銀行已經在歐洲地區也累積許多國際學生用戶，由於開戶簡易、APP 功能完善的優點對留學生而言可以省去大部分複雜的程序。

另一個優點是 N26 提供虛擬和實體的 Debit Card 選項，刷外幣可以享有優惠的匯率且不收取任何手續費、帳管費 (一般銀行可能會收取 1%-5%) ，並且可以於手機 App 上鎖卡，安全性也十分嚴謹。

目前 N26 在以下歐洲國家支援開戶，因此，若是外國人通常會需要相關的居留身份文件以利驗證身份 (詳細訊息請參考 [^n26-supported-contries])：
...
- Estonia
- Finland
- France (not available for residents in the DOM/TOM)
- Germany
- Greece
- Iceland
- Ireland
